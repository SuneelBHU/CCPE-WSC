...
function GraphMatrix() public  returns (uint [4][4] memory ) {         
 
          uint256[4][4] memory predefinedValues = [
            [uint256(0), uint256(10), uint256(30), uint256(100)],
            [uint256(10), uint256(0), uint256(0), uint256(0)],
            [uint256(30), uint256(0), uint256(0), uint256(60)],
            [uint256(100), uint256(0), uint256(60), uint256(0)]
            ];
